...
export function View({
    ...
    if (meshSurfAddr) {
        const ensembleIdent = EnsembleIdent.createRegularEnsembleIdentString(
            meshSurfAddr.caseUuid,
            meshSurfAddr.ensemble
        );
        fieldIdentifier = ensembleSet.findRegularEnsemble(ensembleIdent)?.getFieldIdentifier() ?? null;
    }
